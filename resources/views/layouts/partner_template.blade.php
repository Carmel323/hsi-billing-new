...
<body>
    ...
    <div class="scrollable blurred-bg">
        ...
        <div class="wrapper">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="auth" class="ms-5 sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item ">
                                <a href="/select-plans" id="sidebarMenu-plans" class="{{ Request::is('select-plans') ? 'sidebar-link active-link' : 'sidebar-link' }}"> - Select Plans</a>
                            </li>
                            @endif
                            <li class="sidebar-item">
            ...
            @if(request()->is('subscription')|| request()->is('provider-info') ||request()->is('company-info') ||request()->is('clicks-report')|| request()->is('profile')|| request()->is('invoices')|| request()->is('creditnotes')|| request()->is('support'))
            <div class="modal fade" id="showAlertSubModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-popup">
                        <div class="modal-header d-flex justify-content-between border-0 bg-popup">
                            ...
                            <button type="button" id="close" class="close border-0 bg-popup" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid text-dark fa-xmark fs-3 mb-4"></i></button>
                        </div>
            ...
            <script>
                ...
                @if($company_info === null || $availability_data === null)
                // Show the modal
                myModal.show();
                @endif
