                ...
                <div class="right-margin mb-0 w-100">
                    <div class="row ">
                        <div class="d-flex flex-row col-lg">
                            <p class="fw-bold left-margin ">Advertiser Id:</p><span class="ms-2">{{$partner->isp_advertiser_id}}</span>
                        </div>
            ...
            <div class="modal-body">
                <form action="/update-partner" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg">
                            <label for="payment_gateway" class="form-label fw-bold">Payment Gateway*</label>
                            <select name="payment_gateway" id="per_page" class="form-select" required>
                                ...
                                <option value="forte" {{ $payment_gateway == 'forte' ? 'selected' : '' }}>Csg Forte(ACH)</option>
                            </select>
                        </div>
                    </div>
                    <input type="text" value="{{$partner->zoho_cust_id}}" name="zoho_cust_id" hidden />
