                        ...
                        <tr>
                            ...
                            <th class=" align-middle position-relative">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <h5 class="text-dark mb-2"><strong>${{ number_format($plan['price'],2) }} + {{ number_format($addon->addon_price,2)}}</strong></h5>
                                    @else
                                    <h5 class="text-dark mb-2"><strong>${{ number_format($plan['price'],2) }} </strong></h5>
                                    @endif
