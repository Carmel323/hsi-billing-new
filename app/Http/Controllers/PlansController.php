...
class PlansController extends Controller
{
    ...
    public function selectPlans()
    {
        if (Session::has('loginPartner')) {
            ...
            return view('partner.select-plans', compact('plans'));
        }
    }
    ...
    public function selectedPlan($plan_id)
    {
        ...
        $existing_selected_plan = SelectedPlan::where('zoho_cust_id', Session::get('loginId'))->first();
